export async function onRequestPost(context) {
  ...
  try {
    ...
    let parsedData = { links: [], categories: {} };
    ...
    if (!parsedData.categories[newLink.category]) {
      parsedData.categories[newLink.category] = [];
    }
    
    parsedData.links.push(newLink);
    parsedData.categories[newLink.category].push(newLink);
